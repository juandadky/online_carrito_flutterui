...
import 'package:online_reservation/burguerpage.dart';
import 'package:online_reservation/foodtabs.dart';
      ...
      child: InkWell(
        onTap: (){
          Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => BurguerPage(heroTag: foodName, foodName: foodName, pricePerItem: price, imgPath: imgPath)
          ));
        },
        child: Container(
          height: 175.0,
